...
import { uploadDocument, setUserContext, analyzeDocument } from '../redux/slices/documentSlice'
...
export const Upload: React.FC = () => {
  ...
  // ✅ Local loading state (manual control)
...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
    const uploadedDoc = await dispatch(uploadDocument({ file: selectedFile, context })).unwrap()
    
    toast.success('Upload successful') // ✅ show toast immediately after upload
    await dispatch(analyzeDocument(uploadedDoc._id)).unwrap() // make sure to use `id` not `_id`
